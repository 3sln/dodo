import * as cherry_core from './cljs.core.js';
import * as dodo_core from '@3sln/dodo';
var dodo_settings = ({ "passiveKey": cherry_core.keyword("passive"), "captureKey": cherry_core.keyword("capture"), "mapMerge": (() => {
...
;
const argseq__22544__auto__5 = ((0) < (cherry_core.alength.call(null, args21))) ? (new cherry_core.IndexedSeq(args21.slice(0), 0, null)) : (null);
...
return self__22376__auto__6.cljs$core$IFn$_invoke$arity$variadic(cherry_core.seq.call(null, seq4));
});
return f1;
})(), "listenerKey": cherry_core.keyword("listener"), "mapPut": (function (m, k, v) {
if (cherry_core.truth_.call(null, cherry_core.map_QMARK_.call(null, m))) {
return cherry_core.assoc.call(null, m, k, v);} else {
...
}), "convertName": cherry_core.name, "isSeq": (function (x) {
...
return cherry_core.not.call(null, cherry_core.string_QMARK_.call(null, x));} else {
return and__23329__auto__8;}
})();
if (cherry_core.truth_.call(null, or__23296__auto__7)) {
return or__23296__auto__7;} else {
return Array.isArray(x);}
}), "shouldUpdate": (function (a, b) {
return (a) !== (b);
}), "mapIter": (function (m) {
if (cherry_core.truth_.call(null, cherry_core.map_QMARK_.call(null, m))) {
return cherry_core.es6_iterator.call(null, cherry_core.map.call(null, (function (_PERCENT_1) {
return cherry_core.into_array.call(null, _PERCENT_1);
}), cherry_core.seq.call(null, m)));} else {
...
return or__23296__auto__9;} else {
return cherry_core.get.call(null, m, cherry_core.keyword.call(null, k));}} else {
